...
public class UserShipping {
	...
	private String userShippingPincode;
	...
	public String getUserShippingPincode() {
		return userShippingPincode;
	}

	public void setUserShippingPincode(String userShippingPincode) {
		this.userShippingPincode = userShippingPincode;
	}
