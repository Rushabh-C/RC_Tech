...
import com.E_comm.service.impl.UserSecurityService;
import com.E_comm.utility.INConstants;
import com.E_comm.utility.MailConstructor;
...
public class HomeController {
	...
	public String forgetPassword(HttpServletRequest request, @ModelAttribute("email") String email, Model model) {
		...
		String encryptedPassword = SecurityUtility.bCryptpasswordEncoder().encode(password);
		...
		SimpleMailMessage newEmail = mailConstructor.passwordConstructResetTokenEmail(appUrl, request.getLocale(), token, user,
				password);
	...
	public String myProfile(Model model, Principal principal) {
		...
		model.addAttribute("listOfCards", true);
	...
	@RequestMapping("/listOfCards")
	public String listOfCards(Model model, Principal principal, HttpServletRequest request) {
		User user = userService.findByUsername(principal.getName());
		model.addAttribute("user", user);
		model.addAttribute("userPaymentList", user.getUserPaymentList());
		model.addAttribute("userShippingList", user.getUserShippingList());
	...
	public String addNewCard(Model model, Principal principal) {
		...
		model.addAttribute("addNewCard", true);
		model.addAttribute("classActiveBilling", true);
		model.addAttribute("listOfShippingAddresses", true);
	...
	public String addNewCard(@ModelAttribute("userPayment") UserPayment userPayment,
	...
	public String updateCard(@ModelAttribute("id") Long cardId, Principal principal, Model model) {
		User user = userService.findByUsername(principal.getName());
	...
	public String removeCard(@ModelAttribute("id") Long cardId, Principal principal, Model model) {
		User user = userService.findByUsername(principal.getName());
		UserPayment userPayment = userPaymentService.findById(cardId);
		...
		if (user.getId() != userPayment.getUser().getId()) {
			...
			model.addAttribute("user", user);
			userPaymentService.removeById(cardId);
	...
	public String updateUserInfo(@ModelAttribute("user") User user, @ModelAttribute("newPassword") String newPassword,
		...
		if (newPassword != null && !newPassword.isEmpty() && !newPassword.equals("")) {
			BCryptPasswordEncoder bCryptpasswordEncoder = SecurityUtility.bCryptpasswordEncoder();
